...
class IngestionWorker:
    ...
    def create_testing_collection(self, vector_size: int, distance: str = "Cosine") -> bool:
        """
...
if __name__ == "__main__":
    ...
    ingestion_worker.create_testing_collection(vector_size=vector_size)
    
    # Append points to collection
    print(f"\n\n{'-' * 100}Appending points to Qdrant...\n")
    ingestion_worker.append_points_to_testing(points)
    print("Done!")
